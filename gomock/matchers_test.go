...
//go:generate mockgen -destination internal/mock_gomock/mock_matcher.go github.com/nigoroll/mock/gomock Matcher
...
import (
	...
	"github.com/nigoroll/mock/gomock/internal/mock_gomock"
)
