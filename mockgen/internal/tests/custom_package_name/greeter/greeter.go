...
import (
	...
	"github.com/nigoroll/mock/mockgen/internal/tests/custom_package_name/client/v1"

	//  matching import suffix and package name
	"github.com/nigoroll/mock/mockgen/internal/tests/custom_package_name/validator"
)
